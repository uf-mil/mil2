...
{
  public:
    CircleObjectNode() : rclcpp::Node("circle_object"), Constants(this), acquire_deadline_(this, maneuver_timeout_)
    {
  ...
  private:
    ...
    // spin forever. This is separate from the Deadline inside CircleObject
