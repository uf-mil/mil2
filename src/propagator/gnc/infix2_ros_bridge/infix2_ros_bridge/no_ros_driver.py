...
# this script works as-is assuming you ran `sdgps sylphase-usbgpsimu2 --antenna-position '[0,0,0]' ! tracker ! decoder ! kf2 ! listen-solution-tcp 1234`
# in another window (when it says "waiting for mangentic calibration," you must yaw the Infix-2 +/- 30 degrees

# expect key errors until fitler is running :)
...
# ---- CONFIG ----
host = "127.0.0.1" # same as localhost imo
port = 1234
child_frame_id = "base_link"
decimation = 1 # this was 10 on old navigator
        ...
        for line in lines[:-1]:
            ...
            if count % decimation == 0:
                ...
                if publish_cb == None:
                    ...
                    publish_cb(odom=odom, absodom=absodom, accel=accel)
...
if __name__ == "__main__":
    while True:
        try:
            go(None) # you do not want a callback if your not using ros2
        except Exception:
            traceback.print_exc()
            time.sleep(1)
