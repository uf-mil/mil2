...
{
  return formatChar == '<' || formatChar == '>' || formatChar == '!' || formatChar == '=' || formatChar == '@';
}

constexpr bool isFormatChar(char formatChar)
{
  return isFormatMode(formatChar) || formatChar == 'x' || formatChar == 'b' || formatChar == 'B' || formatChar == 'c' ||
         formatChar == 's' || formatChar == 'h' || formatChar == 'H' || formatChar == 'i' || formatChar == 'I' ||
         formatChar == 'l' || formatChar == 'L' || formatChar == 'q' || formatChar == 'Q' || formatChar == 'f' ||
         formatChar == 'd' || formatChar == '?' || internal::isDigit(formatChar);
}
...
using RepresentedType = std::conditional_t<Fmt::isNative(), typename BigEndianFormat<FormatChar>::NativeRepresentedType,
...
constexpr FormatType getTypeOfItem(Fmt)
{
  ...
  constexpr FormatType sizedFormat = { format.formatChar, getSize<Fmt, format.formatChar>(),
