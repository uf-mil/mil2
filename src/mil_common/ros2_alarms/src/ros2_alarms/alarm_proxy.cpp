...
{
  *this = AlarmProxy(_alarm_name, _raised, "", _problem, _json, _severity);
}

AlarmProxy::AlarmProxy(ros2_alarms_msgs::msg::Alarm msg)
{
...
ros2_alarms_msgs::msg::Alarm AlarmProxy::as_msg()
{
