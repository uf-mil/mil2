...
#include <std_srvs/srv/set_bool.hpp>  // For ROS2 service
                  ...
                  public gz::sim::ISystemPostUpdate
{
  public:
    ...
    // Service Callback
    void LaunchTorpedo(std::shared_ptr<std_srvs::srv::SetBool::Request> const request,
  ...
  private:
    ...
    bool service_called = false;  // Track if the service was called to spawn torpedoes
