...
GZ_ADD_PLUGIN(scoring_plugin::ScoringPlugin,
              gz::sim::System,
              scoring_plugin::ScoringPlugin::ISystemConfigure,
...
void ScoringPlugin::Configure(const gz::sim::Entity &entity,
...
void ScoringPlugin::PostUpdate(const gz::sim::UpdateInfo &info,
...
bool ScoringPlugin::SubPassedThroughGate(const gz::math::Pose3d &subPose,
...
double ScoringPlugin::getAngleBetweenVectors(const gz::math::Pose3d &subPose, const gz::math::Pose3d &gatePose)
{
