...
def main():
    ...
    parser.add_argument("--zero", action="store_true", help="Set zero rate (0), useful for testing thruster pipeline with no effort")
    ...
    if args.zero:
        ...
        raise ValueError("No rate specified! Use --rate, --zero, --slow, --medium, or --fast.")
