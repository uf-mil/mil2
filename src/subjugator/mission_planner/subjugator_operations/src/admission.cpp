...
class Admission : public BT::StatefulActionNode
{
  ...
  public:
    Admission(std::string const &name, const BT::NodeConfig &config) : BT::StatefulActionNode(name, config)
    {
    ...
    {
        return { BT::InputPort<std::string>("mission", "") };
    }

    BT::NodeStatus onStart() override
    {
        auto req = std::make_shared<subjugator_msgs::srv::Admission::Request>();
