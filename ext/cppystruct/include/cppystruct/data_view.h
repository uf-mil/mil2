...
// Get
template <typename T>
constexpr T get(data_view<char const> const& d);

template <>
constexpr uint8_t get(data_view<char const> const& d)
{
    return static_cast<uint8_t>(d.bytes[0] & '\xFF');
}

template <>
constexpr bool get(data_view<char const> const& d)
{
    return get<uint8_t>(d) != '\0';
}

template <>
constexpr uint16_t get(data_view<char const> const& d)
{
    uint16_t v = 0;
    if (!d.isBigEndian)
    {
...
template <>
constexpr uint32_t get(data_view<char const> const& d)
{
    uint32_t v = 0;
    if (!d.isBigEndian)
    {
...
template <>
constexpr uint64_t get(data_view<char const> const& d)
{
    uint64_t v = 0;
    if (!d.isBigEndian)
    {
...
template <>
constexpr int8_t get(data_view<char const> const& d)
{
...
template <>
constexpr int16_t get(data_view<char const> const& d)
{
...
template <>
constexpr int32_t get(data_view<char const> const& d)
{
...
template <>
constexpr int64_t get(data_view<char const> const& d)
{
...
template <>
inline double get(data_view<char const> const& d)
{
...
template <>
inline float get(data_view<char const> const& d)
{
...
template <>
constexpr std::string_view get(data_view<char const> const& d)
{
...
template <typename T>
using integer_type =
    std::conditional_t<std::is_signed_v<T>, typename std::make_signed_t<typename unsinged_integer<sizeof(T)>::type>,
...
template <typename T>
constexpr auto get(data_view<char const> const& d)
{
