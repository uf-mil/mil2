...
{
    REQUIRE_STATIC(
        pystruct::pack(PY_STRING(">BHILQ"), 254, 65534, 4294967294UL, 4294967294UL, 18446744073709551614ULL) ==
...
{
    REQUIRE_STATIC(pystruct::pack(PY_STRING(">bhilq"), -127, -32767, -2147483647, -2147483647, -9223372036854775807) ==
...
TEST_CASE("pack string", "[cppystruct::pack]")
{
    ...
    REQUIRE_STATIC(pystruct::pack(PY_STRING("<h5s"), 126, "12345") == "\x7e\x00"
                                                                      "12345"sv);
    REQUIRE_STATIC(pystruct::pack(PY_STRING(">h5s"), 126, "12345") == "\x00\x7e"
                                                                      "12345"sv);
    ...
    REQUIRE_STATIC(pystruct::pack(PY_STRING("<2c3s2H"), 'x', 'y', "zwt  __", 0x1234, 0x5678) ==
